...
def visualize(dets_dir, lidar_dir, eval_dir):
    ...
    render_option(opt, background_color=np.asarray([0.15, 0, 0]), point_size=1, line_width=2)

    vis2 = o3d.visualization.Visualizer()
    vis2.create_window(window_name='Open3D-Focus-Trk')
    opt2 = vis2.get_render_option()
    render_option(opt2, background_color=np.asarray([0, 0, 0]), point_size=2, line_width=2)
